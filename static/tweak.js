...
(() => {
  ...
  const SCHEMA = [
    ...
    {
      g: 'Tape',
      note: 'The Experience page is a recording. Playback stops for good the first time a hand takes it.',
      c: [
        { k: 'tape', t: 'bool', d: true, l: 'Tape plays itself' },
        { k: 'tapeMs', t: 'range', d: 6000, min: 1500, max: 20000, step: 250, u: 'ms', l: 'Epoch dwell' },
        { k: 'kMarker', t: 'range', d: 1, min: 0.4, max: 1.8, step: 0.01, css: '--k-marker', fx: 'resample', l: 'Scale · year marker' },
        { k: 'tapeGap', t: 'range', d: 3.2, min: 0, max: 10, step: 0.1, u: 'vh', css: '--tape-gap', fx: 'resample', l: 'Track offset' },
        // The tick height and the head's parked position are the same number, and
        // the park is only recomputed on a transition -- so these re-measure rather
        // than resolving on the next frame, or the head would sit at the old tick
        // height until the visitor happened to navigate.
        { k: 'tapeTickH', t: 'range', d: 9, min: 2, max: 30, step: 1, u: 'px', css: '--tape-tick-h', fx: 'resample', l: 'Track tick' },
        { k: 'tapeRunA', t: 'range', d: 18, min: 0, max: 60, step: 1, u: '%', css: '--tape-run-a', l: 'Track run fill' },
        { k: 'tapeHead', t: 'bool', d: true, fx: 'resample', l: 'Caret parks on the track' },
      ],
    },
    {
      g: 'Plate',
